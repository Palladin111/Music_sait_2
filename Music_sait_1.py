...
lists_genres = ['hip-hop', 'jazz', 'blues', 'country', 'rock']
i = 1
...
i = 1
j = 1
for list_1 in lists_performers:
...
lists_collections = [['collections_1', 2018], ['collections_2', 2019], ['collections_3', 2019],
...
for list in lists_tracks:
    for list_1 in list:
        l.append(list_1[0])
list_tracks_for_collections = [[1, 4, 10, 11], [5, 6, 8, 13, 16], [3, 7, 14, 15, 19], [1, 2, 4, 9, 12, 17],
                               [1, 8, 15, 18], [3, 5, 8, 11, 16], [1, 4, 7, 12, 14], [3, 5, 12, 17, 18, 19]]
